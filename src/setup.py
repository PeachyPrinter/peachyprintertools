...
setup(
    ...
    dependency_links=['https://github.com/PeachyPrinter/peachy-firmware-flash/releases/download/0.0.1.22/PeachyPrinterFirmwareAPI-0.0.1.22.tar.gz'],
    install_requires=[
      'protobuf>=2.6.1',
      'pyserial>=2.7',
      'numpy>=1.9.2',
      'libusb1>=1.3.1',
      'PeachyPrinterFirmwareAPI==0.0.1.22'
    ],
