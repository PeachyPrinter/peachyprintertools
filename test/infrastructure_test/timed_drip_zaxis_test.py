...
from infrastructure.timed_drip_zaxis import TimedDripZAxis,PhotoDripZAxis
...
class PhotoDripZAxisTests(unittest.TestCase):
    ...
    def test_calling_move_to_changes_z_height_only_after_delay(self):
        ...
        test_zaxis = PhotoDripZAxis(expected_delay)
        test_zaxis.move_to(expected_height)
    ...
    def test_should_call_callback_when_something_changes(self):
        expected_height = 10.0
        expected_delay = 0.0
        test_zaxis = PhotoDripZAxis(expected_delay, call_back = self.call_back)
        test_zaxis.move_to(expected_height)
    ...
    def test_set_call_back_should_add_callback(self):
        ...
        expected_delay = 0.0
        test_zaxis = PhotoDripZAxis(expected_delay, call_back = None)
