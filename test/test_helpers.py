...
class TestHelpers(NumpyTestHelpers,CommandTestHelpers, DefaultsHelpers):
    ...
    def assertConfigurationEqual(self, expected, actual):
        ...
        self.assertEquals(expected.calibration.scale                    , actual.calibration.scale                    , "calibration.scale did not match expected %s was %s"                     % (expected.calibration.scale                    , actual.calibration.scale                    ))
