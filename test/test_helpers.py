...
class TestHelpers(NumpyTestHelpers,CommandTestHelpers, DefaultsHelpers):
    ...
    def assertConfigurationEqual(self, expected, actual):
        ...
        self.assertEqual(expected.micro_com.header                      , actual.micro_com.header                     , "micro_com.header did not march expected %s was %s"                      % (expected.micro_com.header                    ,  actual.micro_com.header                     ))
        self.assertEqual(expected.micro_com.footer                      , actual.micro_com.footer                     , "micro_com.footer did not march expected %s was %s"                      % (expected.micro_com.footer                    ,  actual.micro_com.footer                     ))
        self.assertEqual(expected.micro_com.escape                      , actual.micro_com.escape                     , "micro_com.escape did not march expected %s was %s"                      % (expected.micro_com.escape                    ,  actual.micro_com.escape                     ))

        self.assertEqual(expected.circut.circut_type                    , actual.circut.circut_type                   , "circut.circut_type did not march expected %s was %s"                    % (expected.circut.circut_type                  ,  actual.circut.circut_type                   ))
        self.assertEqual(expected.circut.version                        , actual.circut.version                       , "circut.version did not march expected %s was %s"                        % (expected.circut.version                      ,  actual.circut.version                       ))
